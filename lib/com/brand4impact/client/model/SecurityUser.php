...
/**
 * SecurityUser Class Doc Comment
 *
 * @category Class
 * @package  com.brand4impact.client.invoker
 * @author   OpenAPI Generator team
 ...
 */
class SecurityUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityUser';
    ...
    {
        $this->container['jwtToken'] = $data['jwtToken'] ?? null;
     ...
     * Sets jwtToken
     *
     * @param string|null $jwtToken jwtToken
     *
     * @return self
     */
