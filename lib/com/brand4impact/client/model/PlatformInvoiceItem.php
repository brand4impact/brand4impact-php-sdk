...
/**
 * PlatformInvoiceItem Class Doc Comment
 *
 * @category Class
 * @package  com.brand4impact.client.invoker
 * @author   OpenAPI Generator team
 ...
 */
class PlatformInvoiceItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlatformInvoiceItem';
     ...
     * Sets amounts
     *
     * @param array<string,string>|null $amounts amounts
     *
     * @return self
     */
