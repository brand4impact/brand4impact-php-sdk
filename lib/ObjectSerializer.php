...
namespace com.brand4impact.client.invoker;

use com.brand4impact.client.invoker\com.brand4impact.client.model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if ($class === '\SplFileObject') {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\com.brand4impact.client.invoker\Model\\' . $data->{$discriminator};
